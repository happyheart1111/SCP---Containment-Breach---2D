...
const placedRooms = [];
const roomCount = 22 + Math.floor(Math.random() * 8);
const corridorEdges = [];
...
let dir = null;
if (isCorridor(sc, sr - 1)) dir = 'down';
else if (isCorridor(sc, sr + 1)) dir = 'up';
else if (isCorridor(sc - 1, sr)) dir = 'right';
else if (isCorridor(sc + 1, sr)) dir = 'left';
if (!dir) continue;
